...
const jwksUrl = 'https://ilkin-test.auth0.com/.well-known/jwks.json';
...
async function verifyToken(authHeader: string): Promise<JwtPayload> {
    ...
    const crt = certToPEM(foundKey["x5c"][0]);
    return verify(token, crt, {
        algorithms: ["RS256"]
    }) as JwtPayload;
}
...
/**
 * Convert the certificate to pem format for decoding
 * @param cert 
 */
